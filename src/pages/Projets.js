...
function Projects() {
  ...
  useEffect(() => {
    ...
    projectsRef.current.forEach(project => observer.observe(project));

    return () => 
      projectsRef.current.forEach(project => observer.unobserve(project));
  }, []);
  ...
  return (
    <div className="projects-section section" id="portfolio">
      ...
      <div className="projects-grid">
        <a href="https://katleenalves.github.io/Habits-Tracker-Application/" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://katleenalves.github.io/doctorcare/" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://linkprojeto4.com" target="_blank" rel="noopener noreferrer">
